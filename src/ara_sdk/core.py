...
def run_cli(app: App | dict[str, Any], argv: Optional[list[str]] = None, *, default_command: str = "deploy") -> None:
    ...
    p_up.add_argument("--activate", default="true")
    p_up.add_argument("--key-name", default="")
    p_up.add_argument("--rpm", type=int, default=60)
    p_up.add_argument("--warm", default="false")
    p_up.add_argument("--warm-workflow", default="")
    p_up.add_argument("--on-existing", choices=["update", "error"])
